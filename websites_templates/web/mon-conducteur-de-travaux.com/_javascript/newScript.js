...
function tagIt() {
var count = document.getElementById("wrapper").getElementsByTagName("a").length;
var parent = document.getElementById("wrapper");
	for(i=0;i < count; i++) {
		parent.getElementsByTagName("span")[i].id = i;
	}
}
function linkIt(id) {
	link = document.getElementById(id).getElementsByTagName("a")[0].href;
	return link;
}
...
function showJobSearch() {
	document.getElementById("jobSearchTextContainer").style.display = "none";
	document.getElementById("jobSearchHook").style.display = "block";
}
function hideJobSearch() {
	document.getElementById("jobSearchTextContainer").style.display = "block";
	document.getElementById("jobSearchHook").style.display = "none";
}
...
var l = window.printframe.location.href;
l = l.substring(l.length-10);
if (l == '/print.php') {
var pf = document.getElementById('printframe');
var pfp = pf.parentNode;
if (pf != null) {
window.setTimeout(setIframe,2000);
}
}
}
function setIframe(text) {
history.go(-2);
}
*/
var wants_reload=true;